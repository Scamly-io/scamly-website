...
const createSystemPrompt = (userLocation: string) => {
  return `
    ...
    17. A users location may be beneficial in performing the assessment. The user you are scanning for now is located in ${userLocation}.
    ...
    */
    ...
    try {
      ...
      */
      ...
      // Build system prompt
      const systemPrompt = createSystemPrompt(profile.country);
