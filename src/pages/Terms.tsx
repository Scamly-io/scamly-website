        ...
        <div className="prose prose-lg dark:prose-invert max-w-none space-y-8">
          ...
          <section>
            ...
            <div className="text-muted-foreground space-y-4">
              <p>
                (a) Welcome to Scamly (Application). The Application is AI-powered fraud detection and scam prevention
                services that analyse digital communications in real-time to help individuals identify and avoid online
                scams, phishing attempts, and fraudulent activities (Services).
              </p>
              <p>
                (b) The Application is operated by SCAMLY PTY LTD (ACN 695941532). Access to and use of the Application,
                or any of its associated Products or Services, is provided by SCAMLY PTY LTD. Please read these terms
                and conditions (Terms) carefully. By using, browsing and/or reading the Application, this signifies that
                you have read, understood and agree to be bound by the Terms. If you do not agree with the Terms, you
                must cease usage of the Application, or any of Services, immediately.
              </p>
              <p>
                (c) SCAMLY PTY LTD reserves the right to review and change any of the Terms by updating this page at its
                sole discretion. When SCAMLY PTY LTD updates the Terms, it will use reasonable endeavours to provide you
                with notice of updates to the Terms. Any changes to the Terms take immediate effect from the date of
                their publication. Before you continue, we recommend you keep a copy of the Terms for your records.
              </p>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="text-muted-foreground space-y-4">
              <p>
                ...
                accept or agree to the Terms where this option is made available to you by SCAMLY PTY LTD in the user
                interface.
              </p>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="text-muted-foreground space-y-4">
              ...
              <p>
                (c) You warrant that any information you give to SCAMLY PTY LTD in the course of completing the
              ...
              <ul className="list-disc pl-6 space-y-2">
                ...
                <li>
                  (ii) you are a person barred from receiving the Services under the laws of Australia or other
          ...
          <section>
            ...
            <div className="text-muted-foreground space-y-4">
              ...
              <ul className="list-disc pl-6 space-y-2">
                ...
                <li>
                  (iii) any use of your registration information by any other person, or third parties, is strictly
                  prohibited. You agree to immediately notify SCAMLY PTY LTD of any unauthorised use of your password or
                ...
                <li>
                  ...
                  Application by you for the purposes of SCAMLY PTY LTD providing the Services;
                </li>
                <li>
                  (v) you will not use the Services or the Application in connection with any commercial endeavours
                  except those that are specifically endorsed or approved by the management of SCAMLY PTY LTD;
                </li>
                <li>
                  (vi) you will not use the Services or Application for any illegal and/or unauthorised use which
                  includes collecting email addresses of Members by electronic or other means for the purpose of sending
                  unsolicited email or unauthorised framing of or linking to the Application;
                </li>
                <li>
          ...
          <section>
            ...
            <div className="text-muted-foreground space-y-4">
              ...
              <p>
                ...
                denied, for whatever reason, by your financial institution or is unpaid by you for any other reason,
          ...
          <section>
            ...
            <div className="text-muted-foreground space-y-4">
              <p>
                (a) SCAMLY PTY LTD will only provide you with a refund of the Services Fee in the event they are unable
                to continue to provide the Services or if the manager of SCAMLY PTY LTD makes a decision, at its
                absolute discretion, that it is reasonable to do so under the circumstances (Refund).
              </p>
              <p>
                (b) Any benefits set out in this Terms and Conditions may apply in addition to consumer's rights under
          ...
          <section>
            ...
            <div className="text-muted-foreground space-y-4">
              ...
              <p>
                ...
                LTD, who grants to you a worldwide, non-exclusive, royalty-free, revocable license whilst you are a
                Member to:
              </p>
              <ul className="list-disc pl-6 space-y-2">
                <li>(i) use the Application pursuant to the Terms;</li>
                <li>
                  (ii) copy and store the Application and the material contained in the Application in your device's
                  cache memory; and
                </li>
                <li>(iii) print pages from the Application for your own personal and non-commercial use.</li>
              </ul>
              <p>
                SCAMLY PTY LTD does not grant you any other rights whatsoever in relation to the Application or the
              ...
              <ul className="list-disc pl-6 space-y-2">
                ...
                <li>
                  (iii) a thing, system or process that is the subject of a patent, registered design or copyright (or
                  an adaptation or modification of such a thing, system or process),
                </li>
              </ul>
              <p>to you.</p>
              <p>
            ...
            <div className="text-muted-foreground space-y-4">
              ...
              <ul className="list-disc pl-6 space-y-2">
                <li>
                  ...
                  defects, delay in operation or transmission, computer virus or other harmful component, loss of data,
          ...
          <section>
            ...
            <div className="text-muted-foreground space-y-4">
              ...
              <p>
                (b) You expressly understand and agree that SCAMLY PTY LTD, its affiliates, employees, agents,
              ...
              <p>
                (c) You acknowledge and agree that the Application utilises artificial intelligence and machine learning
                technologies to analyse digital communications and detect potential scams or fraudulent activity. Such
              ...
              <ul className="list-disc pl-6 space-y-2">
                <li>
                  (i) reliance on any analysis, alert, recommendation or output generated by the Application's AI
                  systems;
                </li>
                <li>
              ...
              <p>
                You accept sole responsibility for any decisions made in reliance on the Application's outputs and are
          ...
          <section>
            ...
            <div className="text-muted-foreground space-y-4">
              <p>
                If you are in the business of providing similar Services for the purpose of providing them to users for
                a commercial gain, whether business users or domestic users, then you are a competitor of SCAMLY PTY
                LTD. Competitors are not permitted to use or access any information or content on our Application. If
                you breach this provision, SCAMLY PTY LTD will hold you fully responsible for any loss that we may
          ...
          <section>
            ...
            <div className="text-muted-foreground space-y-4">
              <p>
                (a) The Terms will continue to apply until terminated by either you or by SCAMLY PTY LTD as set out
                below.
              </p>
          ...
          <section>
            ...
            <div className="text-muted-foreground space-y-4">
              <p>
                You agree to indemnify SCAMLY PTY LTD, its affiliates, employees, agents, contributors, third party
              ...
              <ul className="list-disc pl-6 space-y-2">
                <li>
                  ...
                  legal fees on a full indemnity basis) incurred, suffered or arising out of or in connection with your
                  content;
                </li>
                <li>
                  (b) any direct or indirect consequences of you accessing, using or transacting on the Application or
          ...
          <section>
            ...
            <div className="text-muted-foreground space-y-4">
              <p>
                The collection, use, storage and disclosure of personal information through the Application complies
                with the Australian Privacy Act 1988 (Cth) and the Australian Privacy Principles. Where the Application
                processes personal data of individuals located in the European Union, SCAMLY PTY LTD will comply with
                the General Data Protection Regulation (EU) 2016/679 (GDPR), including implementing appropriate
                technical and organisational measures to ensure data security, providing data breach notifications
                within 72 hours where required, and facilitating user rights including access, rectification, erasure,
