const warmGlowOne =
  "radial-gradient(ellipse at 30% 20%, hsl(27 100% 95%) 0%, hsl(48 96% 89%) 35%, hsl(270 100% 98%) 65%, transparent 100%)";
const warmGlowTwo =
  "radial-gradient(ellipse at 70% 30%, hsl(270 100% 98%) 0%, hsl(327 73% 97%) 40%, hsl(27 100% 95%) 80%, transparent 100%)";
const warmGlowThree =
  "radial-gradient(ellipse at 50% 40%, hsl(327 73% 97%) 0%, hsl(270 100% 98%) 50%, hsl(27 100% 95%) 100%)";
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div
          ...
          style={{
            ...
            animation:
              "heroGlow 12s ease-in-out 4s infinite alternate-reverse",
          }}
        />
        <div
