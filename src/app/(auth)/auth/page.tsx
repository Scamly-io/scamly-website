            ...
            <form onSubmit={(e) => e.preventDefault()} className="space-y-4">
              ...
              {mode === "forgot" && !forgotEmailSent && (
                <>
                  ...
                  <Button variant="default" size="lg" className="w-full mt-6" onClick={handleForgotPassword} disabled={loading}>
                ...
                <>
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <Input id="firstName" type="text" placeholder="John" value={firstName} onChange={(e) => setFirstName(e.target.value)} className="pl-10" />
                    </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <select id="country" value={country} onChange={(e) => setCountry(e.target.value)} className="w-full h-11 pl-10 pr-4 rounded-lg border border-input bg-background text-foreground focus:outline-none focus:ring-2 focus:ring-ring">
                  ...
                  <div className="space-y-2">
                    ...
                    <select id="referralSource" value={referralSource} onChange={(e) => setReferralSource(e.target.value)} className="w-full h-11 px-4 rounded-lg border border-input bg-background text-foreground focus:outline-none focus:ring-2 focus:ring-ring">
                      <option value="">Select an option</option>
                      {referralSourceOptions.map((source) => (<option key={source} value={source}>{source}</option>))}
                    </select>
              ...
              {mode !== "forgot" && (
                <>
                  <Button variant="default" size="lg" className="w-full mt-6" onClick={() => {
                  ...
                  {(mode === "signin" || (mode === "signup" && step === 1)) && (
                    <>
                      ...
                      <Button variant="outline" size="lg" className="w-full" onClick={async () => {
                        const { error } = await supabase.auth.signInWithOAuth({ provider: "apple", options: { redirectTo: `${window.location.origin}/portal` } });
              ...
              <p className="text-center text-sm text-muted-foreground mt-6">
                {mode === "signin" ? (
                  <>
                    ...
                    <button onClick={() => { setMode("signup"); setStep(1); }} className="text-primary hover:underline font-medium">Sign up</button>
                  </>
                ) : (
                  <>
                    Already have an account?{" "}
                    <button onClick={() => { setMode("signin"); setStep(1); }} className="text-primary hover:underline font-medium">Sign in</button>
                  </>
                )}
              </p>
            )}
